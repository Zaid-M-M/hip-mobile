...
const WhitePaperCard = ({ blog }) => {
  ...
  const blogUrl = `/white-paper/${blog.slug}`;
  ...
  const categoryColor = (() => {
    ...
    const colorMap = {
      "SUPPLY CHAIN & WAREHOUSING": "#1E40AF",
      "INDUSTRIAL DEVELOPMENT": "#059669",
      "SUSTAINABILITY & ESG": "#7C3AED",
      "TECHNOLOGY & INNOVATION": "#DC2626",
      "MARKET ANALYSIS": "#EA580C",
      POLICY: "#8B5CF6",
      DEFAULT: "#000000",
    };
