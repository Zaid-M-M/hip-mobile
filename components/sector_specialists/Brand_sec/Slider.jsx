...
//             <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 flex items-center justify-center gap-4 z-10 pb-4">
//               <div className="swiper-button-prev-custom min-h-[50px] w-[50px] flex items-center justify-center cursor-pointer">
//                 <img
//                   src="/sector/leftr.svg"
...
//                 />
//               </div>
//               <div className="swiper-button-next-custom min-h-[50px] w-[50px] flex items-center justify-center cursor-pointer">
//                 <img
//                   src="/sector/rightr.svg"
//                   className="w-8 h-8 lg:w-10 lg:h-10"
//                   alt=""
...
// number of logos per tab folder (tab1 → 3 logos, tab2 → 10 logos, etc.)
const logosPerTab = [19, 9, 17, 24, 9, 7, 12];
